...
// Omaha's app ID
//
#define OMAHA_APP_ID L"{430FD4D0-B729-4F61-AA34-91526481799D}"
const wchar_t const kOmahaAppId[] = OMAHA_APP_ID;
const GUID kOmahaGuid = {0x430FD4D0, 0xB729, 0x4F61,
...
#define USER_REG_CLIENTS_GOOPDATE  USER_REG_CLIENTS OMAHA_APP_ID
#define USER_REG_CLIENT_STATE USER_KEY GOOPDATE_REG_RELATIVE_CLIENT_STATE
#define USER_REG_CLIENT_STATE_GOOPDATE USER_REG_CLIENT_STATE OMAHA_APP_ID
